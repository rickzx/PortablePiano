...
class Key(pygame.sprite.Sprite):
    ...
    def draw(self, surface):
        ...
        if self.type == "black":
            if self.mode == 0:
                drawImageTL(surface, "media/keys/original/" + self.type + ".png", self.x, self.y, (35, 120))
            if self.mode == 1:
                drawImageTL(surface, "media/keys/yellow/" + self.type + ".png", self.x, self.y, (35, 120))
            if self.mode == 2:
                drawImageTL(surface, "media/keys/highlighted/" + self.type + ".png", self.x, self.y, (35, 120))
        elif self.type == "white2":#right white key
            if self.mode == 0:
                drawImageTL(surface, "media/keys/original/" + self.type + ".png", self.x-1, self.y+1, (58, 200))
            if self.mode == 1:
                drawImageTL(surface, "media/keys/yellow/" + self.type + ".png", self.x-1, self.y+1, (58, 200))
            if self.mode == 2:
                drawImageTL(surface, "media/keys/highlighted/" + self.type + ".png", self.x, self.y, (58, 200))
        else:#left white key and middle white key 
            if self.mode == 0:
                drawImageTL(surface, "media/keys/original/" + self.type + ".png", self.x, self.y, (58, 200))
            if self.mode == 1:
                drawImageTL(surface, "media/keys/yellow/" + self.type + ".png", self.x, self.y, (58, 200))
            if self.mode == 2:
                drawImageTL(surface, "media/keys/highlighted/" + self.type + ".png", self.x, self.y, (58, 200))
